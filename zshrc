...
menu () {
    ...
    if [[ "$choice " == "sysadmin"* ]]; then
        ...
        whiptail --menu "Menu" 25 80 15 alsamixer "Mixer TUI" ffmpeg "Media transcoder and more" grim "Screenshots for wayland"  mpc "MPD client" mpv "Media player" pactl "CLI for pulseaudio" pulsemixer "Pulseaudio mixer TUI" wiremix "Pipewire mixer TUI" yt-dlp "Youtube downloader"    2> ~/.menuchoice
        eval $(cat ~/.menuchoice)
...
alias v="swayimg"
alias x='~/dotfiles/scripts/translate.sh'
