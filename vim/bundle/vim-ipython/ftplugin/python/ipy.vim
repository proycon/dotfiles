...
if g:ipy_perform_mappings != 0
    ...
    map <silent> <C-F9> :python run_these_lines()<CR>
    ...
    map <silent> <C-q> :python run_this_line()<CR>

    nmap <leader>p  :python run_this_line()<CR>
    vmap <leader>p  :python run_these_lines()<CR>

    imap <silent> <C-q> <C-O>:python run_this_line()<CR>
