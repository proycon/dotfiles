...
aur: yay abuild aercbook-bin gomuks-git lf-sixel-git lsix-git mblaze-git otf-nerd-fonts-fira-mono powerline-fonts-git rofi-lbonn-wayland telegram-tg-git todotxt ttf-material-design-icons-git ttf-symbola waybar-hyprland-git

.PHONY: abuild aercbook-bin gomuks-git lf-sixel-git lsix-git mblaze-git otf-nerd-fonts-fira-mono powerline-fonts-git rofi-lbonn-wayland telegram-tg-git todotxt ttf-material-design-icons-git ttf-symbola waybar-hyprland-git
abuild aercbook-bin gomuks-git lf-sixel-git lsix-git mblaze-git otf-nerd-fonts-fira-mono powerline-fonts-git rofi-lbonn-wayland telegram-tg-git todotxt ttf-material-design-icons-git ttf-symbola waybar-hyprland-git:
ifeq ($(DISTRO),arch)
	yay -S $@
endif
