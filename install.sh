...
if [ $SUDO -eq 1 ]; then
    if [[ "$OS" == "debian" ]]; then
        ...
        sudo pacman -Syyu --needed sway swaylock swaybg swayidle mako bemenu wtype wofi xdg-desktop-portal-wlr libpipewire02 slurp grim wl-clipboard i3status xorg-xwayland
        YAY=0
        while true; do
